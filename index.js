...
FETCHSCRIPT(SCRIPTAGENT).then(v => {
    ...
    v.stack.forEach(vv => {
        ...
        const data = [
            ...
            ['undistributed gas*', FETCHFUNC('0xda65b600f7124ce6c79950c1772a36403104f2be', 'currentIndex', []).then(vvv => FETCHFUNC(NEO, 'unclaimedGas', [{ type: 'Hash160', value: scripthash }, { type: 'Integer', value: `${Number(vvv.stack[0].value)+1}` }])).then(vvv => vvv.stack[0].value)],
