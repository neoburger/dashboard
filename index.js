...
const SCRIPTAGENT = ''
...
FETCHSCRIPT(SCRIPTAGENT).then(v => {
    ...
    v.stack.forEach(vv => {
        ...
        const data = [
            ...
            ['undistributed gas*', FETCHFUNC('0xda65b600f7124ce6c79950c1772a36403104f2be', 'currentIndex', []).then(vvv => FETCHFUNC(NEO, 'unclaimedGas', [{ type: 'Hash160', value: scripthash }, { type: 'Integer', value: String(Number(vvv.stack[0].value)+1) }])).then(vvv => vvv.stack[0].value)],
            ...
            ['target logo', FETCHFUNC(NEO, 'getAccountState', [{ type: 'Hash160', value: scripthash }]).then(vvv => FETCHSCRIPT(btoa(['\x0c', '\x21'].concat([...atob(vvv.stack[0].value[2].value)]).concat(['\x41','\xcf','\x99','\x87','\x02']).join('')))).then(vvvv => `0x${[...atob(vvvv.stack[0].value)].map(c => c.charCodeAt(0).toString(16).padStart(2, 0)).reverse().join('')}`).then(vvvvv => FETCHFUNC(COMMITTEEINFO, 'getInfo', [{ type: 'Hash160', value: vvvvv }])).then(vvvvvv => {
                const vvvvvvv = atob(vvvvvv.stack[0].value[9].value);
                return vvvvvvv.startsWith("http") ? vvvvvvv : `https://filesend.ngd.network/gate/get/CeeroywT8ppGE4HGjhpzocJkdb2yu3wD5qCGFTjkw1Cc/${vvvvvvv}`;
            }) ],
        ];
        data.forEach(([k, f]) => {
